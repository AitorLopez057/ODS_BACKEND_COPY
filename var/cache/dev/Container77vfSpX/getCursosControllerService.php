...
class getCursosControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\CursosController'] = $instance = new \App\Controller\CursosController(new \App\Service\CursosService(($container->privates['App\\Repository\\CursoRepository'] ?? $container->load('getCursoRepositoryService'))));
